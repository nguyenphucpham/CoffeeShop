...
namespace WebAPI.Migrations
{
    ...
    [Migration("20220709114303_Update_add_more_check_constrains")]
    partial class Update_add_more_check_constrains
    {
            ...
            modelBuilder.Entity("WebAPI.Data.Models.Employee", b =>
                {
                    ...
                    b.HasCheckConstraint("CK_Employee_StartDOB", "`StartDate` > `DOB`");

                    b.HasCheckConstraint("CK_Employee_StartResign", "`ResignDate` IS NULL OR `StartDate` < `ResignDate`");
                });
            ...
            modelBuilder.Entity("WebAPI.Data.Models.OrderDetail", b =>
                {
                    ...
                    b.HasCheckConstraint("CK_OrderDetails_Count_Range", "`Count` >= 1 AND `Count` <= 100");
                });
